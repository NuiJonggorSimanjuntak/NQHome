...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-sm-6 light">
                <div class="calendar">
                    ...
                    <div class="text-center mt-0">
                        <form action="/santri/simpanAbsen" method="POST" class="d-inline">
            ...
            <div class="col-sm-3">
                <div class="card-body">
                    <form action="<?= base_url('santri/generateQR'); ?>" method="post">
                        <?= csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" id="edit-jam-keluar" name="jam_keluar" class="form-control <?php if (session('errors.jam_keluar')) : ?>is-invalid<?php endif ?>" value="15:00">
                            <div class="invalid-feedback">
